classdef MMRBuilder
	...
	methods
        ...
        function        ensureTracerLocation(this)
            %% ENSURETRACERLOCATION creates this.sessionData.tracerLocation as needed.
        ...
        function        ensureTracerSymlinks(this)
            %% ENSURETRACERSYMLINKS operates in pwd, ensuring links to mpr, mpr_to_atlas_t4, T1, t2, tof, ct.
