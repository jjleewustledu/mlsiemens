                ...
                try
                    switch (sessd.tracer)
                        ...
                        case 'OO'
                            ...
                            view(this.product);
                        case 'FDG'
                            this = Herscovitch1985.constructCmrglc(sessd, varargin{:});
                            view(this.product);
                        otherwise
	...
	methods
        ...
        %% ctor
 		...
 		function this = Herscovitch1985(varargin)
            ...
            tzero = seconds(this.scanner_.datetime0 - this.aif_.datetime0) + ...
                    this.scanner.time0; % zero-times in the aif frame
