classdef Test_Herscovitch1985Bayes < matlab.unittest.TestCase
	...
	methods (Test)
        ...
        function test_aifs(this)
            ...
            %save('twilite', fullfile(this.sessionData.sessionPath, 'twilite.mat'));
        end
 	...
 	methods (TestClassSetup)
		function setupHerscovitch1985Bayes(this)            
            import mlraichle.*;
            studyd = StudyData;
            studyd.subjectsDir = mlraichle.RaichleRegistry.instance.subjectsDir;
            ...
            switch (tr)
                case 'HO'
                    ...
                    this.aif = Twilite( ...
                        ...
                        'twiliteCrv', fullfile(this.sessionData.sessionPath, this.crv), ...
