classdef Test_Herscovitch1985 < matlab.unittest.TestCase
	...
	methods (Access = private)
        ...
        function this = configTracer(this, tr)
            ...
            xlsxFqfn = fullfile(getenv('PPG'), 'jjlee2', 'Documents', 'CCIRRadMeasurements 2016sep23.xlsx');
            switch (tr)
                case 'HO'
                    ...
                    this.scanner = BiographMMR0(pic.niftid, ...
                        ...
                        'invEfficiency', this.MMREff);
                    this.scanner.time0 = 0;
                    this.scanner.timeF = 60;
                    this.scanner.dt = 1;
                    this.aif = Twilite( ...
                        'scannerData', this.scanner, ...
                        'filename', fullfile(this.sessionData.vLocation, this.crv), ...
                        'invEfficiency', this.twiliteEff, ...
                        'aifTimeShift', -20, ...
                        'manualData', XlsxObjScanData('sessionData', this.sessionData, 'fqfilename', xlsxFqfn));
                case 'OO'
