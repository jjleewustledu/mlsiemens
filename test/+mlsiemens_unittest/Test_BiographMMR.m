classdef Test_BiographMMR < matlab.unittest.TestCase
	...
	properties
        ...
        invEff = 1.155
        msk = '/data/nil-bluearc/raichle/PPGdata/jjlee2/HYGLY28/V2/FDG_V2-AC/aparcAsegBinarized_op_fdgv2r1.4dfp.ifh'
 		registry
        sessd
        sessdt = datetime(2016,9,23, 12,43,52);
        sessp = '/data/nil-bluearc/raichle/PPGdata/jjlee2/HYGLY28'
 		testObj
        tracerResolvedFast = '/data/nil-bluearc/raichle/PPGdata/jjlee2/HYGLY28/V2/FDG_V2-AC/fdgv2r2_fast.4dfp.ifh';
    end
